...
/* harmony export */ });
/* harmony import */ var crypto_libraries_sha1__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! crypto-libraries/sha1 */ "./node_modules/crypto-libraries/sha1.js");
...
class Faust {
  ...
  compileCodes(code, argv, internalMemory) {
    return __async(this, null, function* () {
      ...
      const shaKey = crypto_libraries_sha1__WEBPACK_IMPORTED_MODULE_0__["default"].hash(this.expandCode(code, argv) + (internalMemory ? "internal_memory" : "external_memory") + strArgv, { msgFormat: "string" });
...
class LibFaustLoader {
  static load(wasmLocation, dataLocation) {
    ...
    const libFaust = _libfaust_wasm__WEBPACK_IMPORTED_MODULE_0__({ locateFile });
    libFaust.then = (f) => {
